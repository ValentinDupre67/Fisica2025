...
VIDEO_PATH = './video/entrada/pelota.mp4'  # ¡¡¡IMPORTANTE: Cambia esto a la ruta de tu video!!!
...
REFERENCE_OBJECT_SIZE_PIXELS = 50 # Ejemplo: Mediste que el objeto mide 50 píxeles
...
REFERENCE_OBJECT_SIZE_METERS = 0.24

# --- Parámetros de Visualización ---
DRAW_BOUNDING_BOX = True
DRAW_CENTER = True
DRAW_TRAIL = False # Poner en True para dibujar la trayectoria (puede ralentizar)
